...
std::vector<BuiltinFunction> make_functions() {
    return {
        ...
        fn("file", "write_chunks", {string_type(), ast::array_of(string_type())}, void_type(), true),
        fn("file", "try_write_chunks", {string_type(), ast::array_of(string_type())}, ast::struct_type("FileActionResult")),
        fn("file", "append_chunks", {string_type(), ast::array_of(string_type())}, void_type(), true),
        fn("file", "try_append_chunks", {string_type(), ast::array_of(string_type())}, ast::struct_type("FileActionResult")),
