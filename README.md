...
- **Stable language contract:** `v1.7`, defined by `docs/SPEC.md`,
  `docs/COMPATIBILITY.md`, and the v1 compatibility tests.
- **Current compiler/tooling/docs release:** `v5.3.0`, focused on the C backend,
...
- Stable v1.7 syntax, diagnostics, modules, tests, and standard-library helpers
