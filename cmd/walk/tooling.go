...
var walkBuiltinDetails = map[string]string{
	...
	"file.try_read":       "func(string) FileReadResult",
	"file.write":          "effect func(string, string) void",
	"file.try_write":      "func(string, string) FileActionResult",
	"file.append":         "effect func(string, string) void",
	"file.try_append":     "func(string, string) FileActionResult",
	"file.exists":         "func(string) bool",
	"dir":                 "draft built-in module",
	"dir.list":            "func(string) array[string]",
	"dir.make":            "effect func(string) void",
	"dir.delete":          "effect func(string) void",
	"path":                "draft built-in module",
	"path.join":           "func(string, string) string",
	"path.base":           "func(string) string",
	"path.ext":            "func(string) string",
	...
	"process.chdir":       "effect func(string) void",
	"process.run":         "func(string, array[string]) ProcessResult",
	"process.output":      "func(string, array[string]) ProcessOutputResult",
	"process.run_shell":   "func(string) ProcessResult",
	...
	"json":                "draft built-in module",
	"json.parse":          "func(string) JsonResult",
	"json.stringify":      "func(string) string",
	"json.read":           "func(string) JsonResult",
	"json.write":          "effect func(string, string) void",
	"term":                "draft built-in module",
	"term.is_tty":         "func() bool",
	"term.color":          "effect func(string) void",
	"term.background":     "effect func(string) void",
	"term.style":          "effect func(string) void",
	"term.reset":          "effect func() void",
	"term.clear":          "effect func() void",
	"term.move":           "effect func(int, int) void",
	"term.width":          "func() int",
	...
	"FileReadResult":      "draft struct { ok bool, value string, error string }",
	"FileActionResult":    "draft struct { ok bool, value bool, error string }",
